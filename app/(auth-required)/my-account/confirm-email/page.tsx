...
export default function ConfirmEmailPage() {
  ...
  return (
    <div>
      <Link
        href={navItems["MyAccount"].href}
        className="flex justify-start items-center gap-2 text-sm text-foreground/80 hover:text-foreground transition-colors"
      >
        <Undo2 />
        <span>Retour</span>
      </Link>
      <Card className="mx-auto max-w-sm my-5">
        <CardHeader>
          <CardTitleH1 className="text-2xl">
            {"Asssocier un email à votre compte"}
          </CardTitleH1>
          <CardDescription>
            {
