  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p>
            Parents List Maker est une application conçue pour faciliter la
            création de listes de parents d'élèves élus. Elle répond à une
            problématique identifiée dans le milieu scolaire et vise à
            simplifier ce processus administratif.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="flex flex-col gap-4">
          <p>
            Je suis Timothée Demares, également connu sous le pseudonyme
            AlexTraveylan. Parent et développeur reconverti depuis 3 ans, j'ai
            créé cette application bénévolement pour répondre à un besoin
            concret.
          </p>
          <Link
      ...
      <Card>
        ...
        <CardContent>
          <p>
            Le projet est en constante amélioration. Les développeurs intéressés
            peuvent contribuer via des pull requests ou me contacter
            directement.
          </p>
